...
Let's assume we have a domain object called `org.tanglongan.model.User`. It is a JavaBean with properties
...
Let's assume our `org.tanglongan.model.User` has preferences such as newsletter subscription and a list of
...
Let's assume a `org.tanglongan.model.User` has a list of skills.
...
If the `org.tanglongan.model.User's` skill were in Herbology, the HTML source of the 'Skills' row would look
like:
...
If the `org.tanglongan.model.User's` house was in Gryffindor, the HTML source of the 'House' row would look
like:
...
If the `org.tanglongan.model.User` lived in the UK, the HTML source of the 'Country' row would look like:
...
fields once we submit the form. We have a validator for instances of the `org.tanglongan.model.User` class
...
----
	public class UserValidator implements Validator {
		...
		public boolean supports(Class candidate) {
			return org.tanglongan.model.User.class.isAssignableFrom(candidate);
		}
